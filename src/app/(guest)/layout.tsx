...
export default function GuestLayout({
  ...
  return (
    <div className={cn(
        ...
        <div className="pointer-events-none fixed inset-0 -z-10 h-full w-full bg-[radial-gradient(circle_at_18%_16%,rgba(212,175,55,0.14),transparent_34%),radial-gradient(circle_at_84%_10%,rgba(185,106,142,0.12),transparent_30%),linear-gradient(150deg,#fffdfa_0%,#fbf7ef_45%,#f5efe3_100%)]" />
