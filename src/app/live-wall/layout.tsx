...
export default function LiveWallLayout({
  ...
  return (
    <div className={cn("font-body antialiased", "bg-background text-foreground", "min-h-screen")}>
        <div className="pointer-events-none fixed inset-0 -z-20 h-full w-full bg-[linear-gradient(140deg,var(--aurora-midnight),var(--aurora-emerald-deep),#030608)] bg-[length:320%_320%] animate-[auroraShift_22s_ease_infinite]" />
